...
class Reserva {
    ...
    // ── OBTENER ÚLTIMA RESERVA DEL USUARIO ───────────────────────────────────
    // Se usa justo después de guardar para obtener el ID asignado y poder
    // adjuntar el PDF en el correo de confirmación.
    public function obtenerUltima($usuario_id) {
        global $pdo;
        $s = $pdo->prepare(
